...
import static utils.HandlingNullValuesInBuilderPattern.handleNoData;
import static utils.HandlingNullValuesInBuilderPattern.handleNoDataBoolean;
import static utils.HandlingNullValuesInBuilderPattern.handleNoDataInteger;
...
import poijiUtils.BookingExcel;
...
public class DataProviders {
	...
	public static Iterator<Booking> getBookingDataUsingPoiji() {
		...
		List<Booking> bookingList = bookingExcelList.stream().map(BookingExcel::toBooking).collect(Collectors.toList());
